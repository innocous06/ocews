...
export const ChapterBlindspot: React.FC = () => {
  return (
    <section id="blindspot" className="py-12 border-t border-neutral-900 max-w-6xl mx-auto px-4 sm:px-6">
      {/* Chapter Marker */}
      ...
      <div className="my-6 text-sm text-neutral-400 font-serif leading-relaxed max-w-3xl">
        <p className="mb-4">
          All modern conjunction assessment feeds sort events by <span className="font-mono text-amber-300">P_c</span> (Probability of Collision), calculated from position covariance ellipsoids and miss distance. But probability measures <em>proximity uncertainty</em> — it is blind to <em>physical outcome severity</em>.
        </p>
        <p>
