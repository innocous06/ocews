...
export const ChapterSandbox: React.FC = () => {
  ...
  return (
    <section id="sandbox" className="py-12 border-t border-neutral-200 dark:border-neutral-900 max-w-6xl mx-auto px-4 sm:px-6">
      {/* Chapter Marker */}
      ...
      <div className="border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-obsidian-950 rounded-xl p-5 sm:p-6 my-6 font-mono text-xs shadow-sm transition-colors duration-200">
        {/* Sliders Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-6">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between">
              ...
              <span className="text-neutral-900 dark:text-neutral-200 font-bold">{mass1.toLocaleString()} kg</span>
            </div>
            <input
              type="range"
              min="2"
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between">
              ...
              <span className="text-amber-700 dark:text-amber-400 font-bold">{mass2.toLocaleString()} kg</span>
            </div>
            <input
              type="range"
              min="2"
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between">
              ...
              <span className="text-neutral-900 dark:text-neutral-200 font-bold">{velocityKms.toFixed(1)} km/s</span>
            </div>
            <input
              type="range"
              min="1.0"
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between">
              ...
              <span className="text-neutral-900 dark:text-neutral-200 font-bold">{altitudeKm} km</span>
            </div>
            <input
              type="range"
              min="250"
          ...
          <div className="space-y-1.5 sm:col-span-2">
            <div className="flex justify-between">
              ...
              <span className="text-neutral-900 dark:text-neutral-200 font-bold">{collisionProb.toExponential(2)}</span>
            </div>
            <input
              type="range"
              min="0.00001"
        ...
        <div className="border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-[#020202] rounded-lg p-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-3 border-b border-neutral-200 dark:border-neutral-900 gap-2 mb-3">
            <div className="flex items-center gap-3">
              <span className="text-neutral-500 text-[10px] uppercase">CALCULATED SCORE:</span>
              <span className="text-2xl font-bold font-serif text-neutral-900 dark:text-neutral-100">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center my-3">
            <div className="border border-neutral-200 dark:border-neutral-900 bg-white dark:bg-obsidian-950 p-2.5 rounded shadow-2xs">
              <span className="text-neutral-500 block text-[10px] uppercase">KINETIC ENERGY</span>
              <span className="text-sm font-bold text-neutral-900 dark:text-neutral-200">{metrics.impactKineticEnergyGJ} GJ</span>
              <span className="text-[10px] text-amber-700 dark:text-amber-400 block mt-0.5 font-sans">
                {metrics.specificEnergyJoulePerGram >= 40 ? '≥40 J/g Catastrophic' : '<40 J/g Sub-breakup'}
              </span>
            </div>
            <div className="border border-neutral-200 dark:border-neutral-900 bg-white dark:bg-obsidian-950 p-2.5 rounded shadow-2xs">
              <span className="text-neutral-500 block text-[10px] uppercase">PREDICTED FRAGS</span>
              <span className="text-sm font-bold text-amber-700 dark:text-amber-400">~{metrics.predictedFragmentsCount.toLocaleString()}</span>
              <span className="text-[10px] text-neutral-500 block mt-0.5">&gt;10 cm trackable</span>
            </div>
            <div className="border border-neutral-200 dark:border-neutral-900 bg-white dark:bg-obsidian-950 p-2.5 rounded shadow-2xs">
              <span className="text-neutral-500 block text-[10px] uppercase">DEBRIS RESIDENCE</span>
            ...
            <div className="border border-neutral-200 dark:border-neutral-900 bg-white dark:bg-obsidian-950 p-2.5 rounded shadow-2xs">
              <span className="text-neutral-500 block text-[10px] uppercase">SHELL MULTIPLIER</span>
              <span className="text-sm font-bold text-neutral-900 dark:text-neutral-200">{metrics.shellDensityMultiplier}x</span>
              <span className="text-[10px] text-neutral-500 block mt-0.5">{metrics.shellDensityRating}</span>
            </div>
          </div>

          <div className="mt-3 pt-3 border-t border-neutral-200 dark:border-neutral-900 text-[11px] text-neutral-600 dark:text-neutral-400 font-serif leading-relaxed">
            <strong className="text-neutral-900 dark:text-neutral-300 font-mono">ASSESSMENT:</strong> {metrics.judgeTakeaway}
          </div>
        </div>
      </div>
    </section>
